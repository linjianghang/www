...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            ...
            uploadClass: 'btn btn-xs btn-default display_false',
        ...
        tActions = '<div class="file-actions">\n' +
            ...
            '        {upload}{delete}{other}' +
            '    </div>\n' +
            '    <div class="file-upload-indicator display_false" tabindex="-1" title="{indicatorTitle}">{indicator}</div>\n' +
            '    <div class="clearfix"></div>\n' +
            '</div>',
    ...
    $.fn.fileinput.defaults = {
        ...
        deleteUrl: '',
        deleteExtraData: {},
        overwriteInitial: true,//单图是是否能更换 删除 false:默认的不能删除 只能新增一个
